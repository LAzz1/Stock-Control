            ...
            <fieldset>
                ...
                <div id="product-information">
                    ...
                    <div id="lote-expiration">
                        ...
                        <input type="date" class="inputData" value="<?php echo $row['expiration'];?>" id="loteexpiration" name="expiration" required>
                    </div>
                    <script>
